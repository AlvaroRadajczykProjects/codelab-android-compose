...
fun SunflowerTheme(
    ...
    val darkColors  = darkColors(
        ...
        onPrimary = colorResource(id = R.color.sunflower_white),
        onSecondary = colorResource(id = R.color.sunflower_white),
        onBackground = colorResource(id = R.color.sunflower_white),
